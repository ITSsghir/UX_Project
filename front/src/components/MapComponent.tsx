...
const MapComponent: React.FC<MapComponentProps> = ({ width, height, artistsData }) => {
  ...
  useEffect(() => {
    ...
    }, [width, height]);  // Add fetchCountryDetails here
    ...
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      {hoveredCountry && (
        <div style={{
          ...
          <ul>
            {Object.entries(hoveredCountry).map(([key, value]) => (
